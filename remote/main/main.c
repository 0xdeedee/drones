...
static adc_channel_t channel[] = { ADC_CHANNEL_3 }; //, ADC_CHANNEL_4, ADC_CHANNEL_5, ADC_CHANNEL_6 };
            ...
            if (ret == ESP_OK) {
                ...
                for (int i = 0; i < ret_num; i += SOC_ADC_DIGI_RESULT_BYTES) {
                    ...
                    if (chan_num < SOC_ADC_CHANNEL_NUM(EXAMPLE_ADC_UNIT)) {
                        ESP_LOGI(TAG, "Unit: %s, Channel: %"PRIu32", Value: %04f", unit, chan_num, data * ( 5.0/1023.0 ) );
                    } else {
